  ...
  const jsonLd = [
    {
      ...
      url: baseUrl,
      description:
        'A registry for agent kits, reusable skills, workspace automation, and evaluation workflows.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Organization',
        ...
        <section className="mx-auto grid w-full grid-cols-1 gap-10 py-12 sm:py-14 lg:grid-cols-[auto_1fr] lg:gap-14 lg:py-16">
          ...
          <div className="flex items-center">
            <p className="text-balance text-center text-xl leading-tight tracking-tight text-muted-foreground sm:text-2xl lg:text-left lg:text-3xl">
              Skills are reusable capabilities for AI agents. Install them with
              a single command to enhance your agents with access to procedural
              knowledge.
            </p>
          </div>
        </section>
