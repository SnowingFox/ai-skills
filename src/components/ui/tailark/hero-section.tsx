...
import { InfiniteSlider } from '@/components/ui/tailark/motion/infinite-slider'
import { ProgressiveBlur } from '@/components/ui/tailark/motion/progressive-blur'
            ...
            <main className="overflow-x-hidden">
                <section>
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        ...
                        <div className="aspect-2/3 absolute inset-1 -z-10 overflow-hidden rounded-3xl border border-black/10 lg:aspect-video lg:rounded-3xl dark:border-white/5">
                            <video
                                autoPlay
                                loop
